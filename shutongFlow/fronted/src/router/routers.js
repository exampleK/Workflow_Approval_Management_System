...
export const appRouters = [
  {
    ...
    component: LayOut,
    children: [
      {path: 'Index', name: 'Index', title: '业绩表', icon: 'android-list', component: () => import('../components/ticket/Index.vue'), meta: {isAdmin: true, hidden: false}},
      {path: 'SelectAll', name: 'SelectAll', title: '查询', icon: 'android-list', component: () => import('../components/ticket/SelectAll.vue'), meta: {isAdmin: true, hidden: false}},
    ],
    meta: {isAdmin: true}
  },
  {
