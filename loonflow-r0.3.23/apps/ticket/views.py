...
class TicketListView(View):
    def get(self, request, *args, **kwargs):
        ...
        if password:
            ...
            ticket_result_restful_list, msg = TicketBaseService.get_update_newpwd(username=username,password=password,newpassword=newPassword)
    ...
    def post(self, request, *args, **kwargs):
        ...
        # print("[path:loonflow-r0.3.23\apps\ticket\views.py]",request_data_dict)
